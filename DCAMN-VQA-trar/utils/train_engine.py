    ...
    for epoch in range(start_epoch, __C.MAX_EPOCH):
        ...
        for step, (
            ...
            for accu_step in range(__C.GRAD_ACCU_STEPS):
                ...
                loss_bce_0 = loss_fn(pred_0, sub_ans_iter)
                loss_bce_1 = loss_fn(pred_1, sub_ans_iter)
        ...
        if dataset_eval is not None:
            # net.module.backbone.set_training_status(False)
            ...
            # net.module.backbone.set_training_status(True)
