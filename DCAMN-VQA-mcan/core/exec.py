...
from core.model.net_attmaskturnsof import Net_attmaskturnsof
...
class Execution:
    ...
    def train(self, dataset, dataset_eval=None):
        ...
        net = Net_attmaskturnsof(
            self.__C,
            pretrained_emb,
            token_size,
            ans_size
        )
        print("****************Net_attmaskturnsof******************")
        net.cuda()
        net.train()
    ...
    def eval(self, dataset, state_dict=None, valid=False):
        ...
        for step, (
            ...
            pred = torch.sigmoid(pred0 + pred1)
